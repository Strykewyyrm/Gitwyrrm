do -- flux ui library
    ...
    if game.CoreGui:FindFirstChild(temp) then
        game.CoreGui[temp]:Destroy()
    end
    ...
    function Flux:Window(text, bottom,mainclr,toclose)
    	...
    	BottomText.Position = UDim2.new(0.097560972, 1, 0.0889999792, 4)
    	...
    	MainFrame:TweenSize(UDim2.new(0, 706, 0, 484), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .05, true)
    		...
    		function(io, p)
    			if io.KeyCode == CloseBind then
    				if uitoggled == false then
    					MainFrame:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .05, true)
    					uitoggled = true
    					wait(.1)
    	...
    	function Flux:Notification(desc, buttontitle)
    		...
    		CloseBtn.Visible = buttontitle and true or false
    		...
    		NotificationDesc.Position = CloseBtn.Visible and UDim2.new(0.112499997, 0, 0.266355127, 0) or UDim2.new(0.112499997, 0, 0.33, 0)
    		...
    		CloseBtn.MouseButton1Click:Connect(function()
    			...
    			NotificationFrame:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .1, true)
    		...
    		NotificationFrame:TweenSize(UDim2.new(0, 400, 0, 214), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .1, true)
    	...
    	function Tabs:Tab(text)
    		...
    		function ContainerContent:Toggle(text, desc, default, callback)
    			...
    			ToggleCircle.Position = UDim2.new(0, -4, -0.272727281, 0)
    			...
    			Toggle.MouseEnter:Connect(function()
    				TweenService:Create(
    					Title,
    					TweenInfo.new(.01, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
    					{TextTransparency = 0}
    				):Play()
    			end)
    			...
    			local function ToggleFunction()
    				if Toggled == false then
    					ToggleCircle:TweenPosition(UDim2.new(0.4, 0,-0.273, 0), Enum.EasingDirection.In, Enum.EasingStyle.Linear, .05, true)
    					TweenService:Create(
    						ToggleCircle,
    						TweenInfo.new(.01, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
    						{BackgroundColor3 =PresetColor}
    					):Play()
    				else
    					ToggleCircle:TweenPosition(UDim2.new(0, -4,-0.273, 0), Enum.EasingDirection.In, Enum.EasingStyle.Linear, .05, true)
    					TweenService:Create(
    						ToggleCircle,
    			...
    			ArrowBtn.MouseButton1Click:Connect(function()
    				if ToggleDescToggled == false then
    					Toggle:TweenSize(UDim2.new(0, 457, 0, 74), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .1, true)
    					TweenService:Create(
    						Title,
    						TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
    						{TextColor3 = PresetColor}
    					...
    					Toggle:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .1, true)
    					TweenService:Create(
    						Title,
    						TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
    						{TextColor3 = Color3.fromRGB(255,255,255)}
    			...
    			if default == true then
    				ToggleCircle:TweenPosition(UDim2.new(0.37, 0,-0.273, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .1, true)
    				TweenService:Create(
    					ToggleCircle,
    					TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
    					{BackgroundColor3 =PresetColor}
